  ...
  body=f'''    <section class="hero">
    ...
    <section class="section">
      <div class="wrap mesure">
        ...
        <div class="result" id="prochain-ramassage">
          <p class="eyebrow" style="margin-bottom:.3rem">Prochain ramassage</p>
          <p class="prochain"><strong class="date-next">à venir</strong></p>
          <p class="next-note">Bac gris (ordures ménagères) et bac jaune (emballages et papiers) ensemble. Pensez à les sortir la veille au soir.</p>
        </div>
        <p>À Acon, les bacs sont ramassés <strong>le jeudi, une semaine sur deux</strong> (les semaines paires). En cas de jour férié, la date peut être décalée : le calendrier ci-dessous fait foi.</p>
        <dl class="def">
      ...
      <div class="wrap">
        ...
        <a class="btn" href="https://www.evreuxportesdenormandie.fr/app/uploads/1/2025/12/Acon-2026.pdf" target="_blank" rel="noopener">Télécharger le calendrier 2026 (PDF officiel)</a>
